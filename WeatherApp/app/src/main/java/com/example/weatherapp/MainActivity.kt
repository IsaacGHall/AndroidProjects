...
fun MainScreen(
    ...
    val latitude: Double? by weatherViewModel.latitude.observeAsState()
    val longitude: Double? by weatherViewModel.longitude.observeAsState()
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Temperature at Latitude: $latitude, Longitude: $longitude is: $temperature °C | $temperatureF °F",
